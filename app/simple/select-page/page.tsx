...
function SelectPageContent() {
  ...
  const handleSelectForm = async (form: Form) => {
    ...
    try {
      ...
      const subscribeResponse = await fetch('/simple/api/facebook/subscribe', {
        method: 'POST',
        ...
        <div className="flex items-center justify-center mb-8 space-x-4">
          ...
          <div className="flex items-center">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
              selectedPage ? 'bg-green-500 text-white' : 'bg-gray-300 text-white'
            }`}>
              {selectedPage ? '✓' : '2'}
            </div>
          ...
          <div className="flex items-center">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
              selectedForm ? 'bg-green-500 text-white' : 'bg-gray-300 text-white'
            }`}>
              {selectedForm ? '✓' : '3'}
            </div>
            ...
            <div className="space-y-3">
              {pages.map((page) => (
                <button
                  ...
                  className="w-full p-4 border rounded-lg hover:bg-blue-50 hover:border-blue-300 transition text-left"
                >
              ...
              <div className="space-y-3">
                {forms.map((form) => (
                  <button
                    ...
                    disabled={loading}
                    className="w-full p-4 border rounded-lg hover:bg-purple-50 hover:border-purple-300 transition text-left disabled:opacity-50"
                  >
                    <div className="flex items-center justify-between">
                      <div>
